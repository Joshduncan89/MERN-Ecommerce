...
export const ORDER_ADMINLIST_REQUEST = "ORDER_ADMINLIST_REQUEST";
export const ORDER_ADMINLIST_SUCCESS = "ORDER_ADMINLIST_SUCCESS";
export const ORDER_ADMINLIST_FAIL = "ORDER_ADMINLIST_FAIL";
export const ORDER_ADMINLIST_RESET = "ORDER_ADMINLIST_RESET";
